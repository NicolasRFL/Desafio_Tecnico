...
class ResultadosController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Resultados->save($resultado)) {
                $this->Flash->success(__('El resultado se guardo correctamente.'));

                return $this->redirect(['action' => 'index']);
            }
            $this->Flash->error(__('El resultado no pudo ser guardado. Por favor, intenta de nuevo.'));
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Resultados->delete($resultado)) {
            ...
            $this->Flash->error(__('El resultado no pudo ser eliminado. Por favor, intenta de nuevo.'));
        }
